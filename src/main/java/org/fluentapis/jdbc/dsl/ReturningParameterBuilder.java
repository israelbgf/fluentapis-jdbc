...
import org.fluentapis.jdbc.converter.IntegerConverter;
...
public class ReturningParameterBuilder {
	...
	public ReturningParameter<Integer> asInteger(){
		return new ReturningParameter<Integer>(columns, new IntegerConverter());
	}
